...
(function ($, _, window, document, undefined) {
    ...
    ThemifyPageBuilder = {
        ...
        saveData: function (loader, callback, saveto, previewOnly) {
            saveto = saveto || 'main';
            var self = ThemifyPageBuilder,
                ids = $('.themify_builder_content').not('.in_the_loop').map(function () {
    ...
    ThemifyLiveStyling = (function ($, jss) {
        ...
        ThemifyLiveStyling.prototype.bindAdditionalCSSClass = function () {
            ...
            this.$context.on('keyup', '#custom_css_row, #add_css_text', function () {
                var className = self.getStylingVal('custom_css_row') || self.getStylingVal('add_css_text');

                self.$liveStyledElmt.removeClass(className);

                className = $(this).val();

                self.setStylingVal('custom_css_row', className);
        ...
        ThemifyLiveStyling.prototype.bindBackgroundSlider = function () {
            ...
            this.$context.on('change', '#background_slider, #background_slider_mode', function () {
        ...
        ThemifyLiveStyling.prototype.bindModuleColor = function() {
            ...
            self.$context.on('click', colorStylingSelector, function() {
                var $this = $(this);
                var colorSelectorKey = $this.parent().attr('id');
