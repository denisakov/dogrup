...
if (!class_exists('Themify_Builder')) {
    ...
    class Themify_Builder {
        ...
        function register_frontend_js_css() {
            ...
            wp_localize_script('themify-builder-module-plugins-js', 'tbLocalScript', apply_filters('themify_builder_script_vars', array(
                'isTouch' => themify_is_touch() ? true : false,
            ...
            wp_localize_script('themify-builder-module-plugins-js', 'themifyScript', array(
            ...
            wp_localize_script('themify-builder-module-plugins-js', 'tbScrollHighlight', apply_filters('themify_builder_scroll_highlight_vars', array(
                'fixedHeaderSelector' => '',
                'speed' => 900,
                'navigation' => '#main-nav',
                'scrollOffset' => 0
        ...
        public function slider_live_styling() {
            ...
            $this->do_slider_background($row_or_col, $bg_slider_data['order'], $bg_slider_data['type']);
            ...
            if ('zip' == $ext[1] || 'rar' == $ext[1] || 'plain' == $ext[1]) {
                ...
                if ('zip' == $ext[1] || 'rar' == $ext[1]) {
                    ...
                    if ($wp_filesystem->exists($destination_path . '/builder_data_export.txt')) {
                        ...
                        $GLOBALS['ThemifyBuilder_Data_Manager']->save_data($data, $postid);
                                ...
                                if (isset($row['cols']) && count($row['cols']) > 0):
                                    ...
                                    foreach ($row['cols'] as $cols => $col):
                                        ...
                                        if (isset($col['styling']['custom_css_column']) && $col['styling']['custom_css_column']) {
                                            ...
                                            unset($col['styling']['custom_css_column']);
                                        }
                                                                ...
                                                                <?php if ($frontedit_active): ?>
                                                                    ...
                                                                    foreach ($mod['cols'] as $col_key => $sub_col) {
                                                                        ...
                                                                        if (isset($sub_col['styling']['custom_css_column']) && $sub_col['styling']['custom_css_column']) {
                                                                            ...
                                                                            unset($sub_col['styling']['custom_css_column']);
                                                                        }
